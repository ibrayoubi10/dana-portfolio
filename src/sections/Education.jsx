...
const data = {
  ...
  ar: {
    ...
    subtitle: "خلفية أكاديمية متينة مدعومة بتدريب متخصّص في التربية الشاملة والتربية الخاصة.",
    eduLabel:  "المسار الأكاديمي",
    certLabel: "الشهادات والتطوّع",
    edu: [
      { icon: "🎓", title: "ماجستير 1 — دبلوم التدريس (تربية خاصة)", meta: "جامعة القديس يوسف، رأس مسقا، لبنان (2023–2024)" },
      { icon: "📖", title: "إجازة — تربية خاصة",                     meta: "كلية العلوم الإنسانية CEULN (2020–2023)" },
      { icon: "🏫", title: "البكالوريا اللبنانية — علوم الحياة",      meta: "ENGO، طرابلس (2014–2020)" },
    ],
    certs: [
      { icon: "👁",  text: "تدريب على محو الأمية بطريقة برايل (المنتدى)" },
      { icon: "🧸",  text: "أساليب حديثة في تعليم رياض الأطفال (IABC)" },
      { icon: "🎵",  text: "تدريب على العلاج بالموسيقى للأطفال ذوي الاحتياجات الخاصة" },
      { icon: "🚒",  text: "دورة السلامة العامة ومكافحة الحرائق (إطفائيو لبنان)" },
      { icon: "❤️", text: "متطوّعة — مائدة المحبة الميناء (توزيع وجبات للمسنّين)" },
      { icon: "🤲",  text: "متطوّعة — تكافل (منظمة خيرية)" },
    ],
  },
};
